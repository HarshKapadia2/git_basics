...
image::git-init.jpg[Git Init, 600, 600]
...
image::dir-1.jpg[Create new directory, 600, 600]
...
image::add-to-master_file_1-1.jpg[Add to Master file, 600, 600]
image::edit-master_file_1-1.jpg[Edit master file, 600, 600]
...
image::cat-1.jpg[Check contents, 600, 600]
...
image::de-compressed.jpg[Decompress, 600, 600]
...
image::commit-master_file_1-1.jpg[Commit master file, 600, 600]
...
image::cat-file-t-1.jpg[Plumbing commands, 600, 600]
...
image::cat-file-p-1.jpg[Commit, 600, 600]
...
image::cat-file-p-2.jpg[Check contents, 600, 600]
...
image::connection-graph-1.png[Connection graph, 600, 600]
...
image::touch-master_file_2.jpg[Create master file, 600, 600]
...
image::cat-file-p-3.jpg[Create another master file, 600, 600]
...
image::mkdir_1.jpg[Create new file in directory, 600, 600]
...
image::cat-file-p-5.jpg[Contets of tree, 600, 600]
...
image::cat-file-p-6.jpg[Contents of directory tree, 600, 600]
...
image::tree-1.png[Tree, 600, 600]

Also have a look at the new graph of the entire repository.

image::connection-graph-3.png[Connection Graph, 600, 600]

==== Renaming a file

Rename `master_file_1.txt` to `the_master_file.txt` to see how Git handles it internally.

image::mv-1.jpg[Rename file, 600, 600]

image::add-1.jpg[Stage, 600, 600]
...
image::cat-file-p-7.jpg[Contents of commit, 600, 600]
...
image::connection-graph-4.png[Connection Graph, 600, 600]
...
+
image::dir-2.jpg[Content of directory, 800, 800]
+
...
+
image::verify-pack-1.jpg[Contents of files, 800, 800]
+
...
image::log-1.jpg[alt="Log of repository"]

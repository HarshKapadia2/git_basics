...
image::cat-file-p-5.jpg[alt="Contets of tree", 600, 600]
...
+
image::dir-2.jpg[alt="Content of directory", 800, 800]
+
...
+
image::verify-pack-1.jpg[alt="Contents of files", 800, 800]
+

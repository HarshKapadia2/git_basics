...
* Steps to be followed
    ...
    ** Connect the link:#_repositories_its_types/:~:text=local%20repo[local] forked repo with the original link:link:index.html#_repositories_its_types/:~:text=remote%20repo[remote] repo.

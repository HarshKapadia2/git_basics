...
It doesn’t let the user switch between branches or put a forked history back together again. For this reason, git branch is tightly integrated with the link:#_git_checkout[`git checkout`] and link:index.html#_git_merge[`git merge`] commands.

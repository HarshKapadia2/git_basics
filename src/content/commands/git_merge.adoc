...
The `git merge` command lets you take the independent lines of development created by link:#_git_branch[`git branch`] or link:index.html#_git_checkout[`git checkout`] and integrate them into a single branch.

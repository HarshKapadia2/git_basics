...
* With `--no-single-branch`, use link:index.html#_git_branch[`git branch -a`] to view the fetched branches and link:index.html#_git_switch[`git switch <branch_name>`] to use it.

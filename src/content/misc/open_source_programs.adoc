...
image::outreachy-logo.png[alt="Outreachy Logo", 600, 264]
...
image::MLH-logo.png[alt="MLH-logo", 600, 300]
...
image::the-linux-foundation-logo.png[alt="Linux-foundation-logo", 600, 300]

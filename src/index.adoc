...
* GitHub is gradually renaming the default link:#_branches[branch] of repositories from `master` to `main`.
* The default branch name for new repositories on GitHub is now `main`.
...
* link:#_global/:~:text=Change%20default%20branch%20name[Changing the default branch of the local Git client] is also possible.

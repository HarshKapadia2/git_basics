...
NOTE: One might want to familiarize themselves with link:#_terms[these] Git terms before starting, although they will be linked at places where they are required as well.

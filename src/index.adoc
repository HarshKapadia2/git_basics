...
* link:#_git_deep[Git Deep]

NOTE: The two articles have been covered as a talk as well. (link:https://talks.harshkapadia.me/git_internals[Git Internals - How Does Git Work!?^])

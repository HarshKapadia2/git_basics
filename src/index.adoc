...
For further questions, please feel free to contact the author, Harsh Kapadia, via link:https://ourtech.community[OTC^], link:https://twitter.com/harshgkapadia[Twitter^], link:https://www.linkedin.com/in/harshgkapadia[LinkedIn^] or e-mail (link:mailto:harshgkapadia@gmail.com[harshgkapadia@gmail.com^]).
...
* link:#_the_git_directory[The `.git` Directory]
* link:#_git_objects[Git Objects]

NOTE: The two articles have been covered as a talk as well. (link:https://www.youtube.com/watch?v=TZRS9llBBYU[Git Internals - How Does Git Work!?^])

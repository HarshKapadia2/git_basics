...
* Most software projects have a bug tracker of some kind. link:index.html#_what_is_github[GitHub’s] tracker is called 'Issues', and has its own section in every repository.
...
* If the link:index.html#_github_repositories[repository is public], then anyone can raise an issue.
* Labels
    ...
    ** Labels for new/beginner contributors:
        *** good-first-issue
        *** link:index.html#_resources/:~:text=first%20timers%20only[first-timers-only]
